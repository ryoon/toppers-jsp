...
public:
    ...
    bool throwException(void) noexcept(false)
#else
...
#endif
    {
        ...
        //マニピュレータ
#if __cplusplus >= 201703
    inline ExceptionMessage & operator << ( ExceptionMessage & (* func)(ExceptionMessage &) ) noexcept(false)
#else
    ...
    //TESTSUITE_PROTOTYPE(main)
        ...
        //例外をスローするためのマニピュレータ
#if __cplusplus >= 201703
    inline ExceptionMessage & throwException(ExceptionMessage & excmsg) noexcept(false)
#else
