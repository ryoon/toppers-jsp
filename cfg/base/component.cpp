...
void Component::setBanner(string src) noexcept(noexcept(std::bad_alloc()))
#else
...
#if __cplusplus >= 201703
string Component::getBanner(void) noexcept(noexcept(std::bad_alloc()))
#else
...
#if __cplusplus >= 201703
        void parseOption(OptionParameter & option) noexcept(false)
#else
...
#if __cplusplus >= 201703
        void onFatalExit(void) noexcept(false)
#else
