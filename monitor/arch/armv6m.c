...
#elif defined(NUCLEO_G0B1RE)
	{0x08000000, 0x0807FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x20000000, 0x20023FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x50060FFF,           PORT_AREA,   MREAD_WRITE},
	{0xA0000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(NXP_OM13058)
	{0x00000000, 0x0003FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x10000000, 0x1007FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x14000000, 0x1400FFFF,           PORT_AREA,   MREAD_WRITE},
	{0x1FFF0000, 0x1FFF7FFF,           MEMORY_AREA, MREAD_ONLY },
	{0x20000000, 0x200047FF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x5000FFFF,           PORT_AREA,   MREAD_WRITE},
	{0xA0000000, 0xA007FFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(RP2040)
	{0x10000000, 0x101FFFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x11000000, 0x18FFFFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x20000000, 0x20041FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0xDFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#else
