 ...
 * 
 *  @(#) $Id: armv7m.c,v 1.2 2026/02/27 17:08:56 roi Exp $
 */
...
static T_MEMDEF const memdefine[] = {
#if defined(NUCLEO_L476RG) || defined(DISC_L476VG)
...
#elif defined(STM32WB55_NUCLEO)
	{0x08000000, 0x080CBFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x20000000, 0x2003FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x6FFFFFFF,           PORT_AREA,   MREAD_WRITE},
	{0x80000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(STM32F407G_DISC1)
	{0x08000000, 0x080FFFFF,           MEMORY_AREA, MREAD_ONLY },
	...
	{0x40000000, 0x50060FFF,           PORT_AREA,   MREAD_WRITE},
	{0xA0000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(NUCLEO_F446RE) || defined(NUCLEO_F446ZE)
	{0x08000000, 0x0807FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x20000000, 0x2001FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x50060FFF,           PORT_AREA,   MREAD_WRITE},
	{0xA0000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(NUCLEO_G474RE)
	{0x08000000, 0x0807FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x10000000, 0x10007FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x20000000, 0x20017FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0xAFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(NUCLEO_G431KB)
	{0x08000000, 0x0801FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x10000000, 0x10002FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x2FFC0000, 0x2FFFFFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0xAFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(STM32F746G_DISC) ||defined(NUCLEO_F746ZG)
...
#elif defined(STM32F769I_DISCO) || defined(NUCLEO_F767ZI)
	{0x00000000, 0x0003FFFF,           MEMORY_AREA, MREAD_WRITE},
	...
	{0x08000000, 0x081FFFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x20000000, 0x0001FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x24000000, 0x2407FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x30000000, 0x30047FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x38000000, 0x3800FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x5802FFFF,           PORT_AREA,   MREAD_WRITE},
	{0x90000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#else
