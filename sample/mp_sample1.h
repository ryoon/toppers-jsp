 ...
 *
 *  @(#) $Id: mp_sample1.h,v 1.36 2007/05/08 07:43:52 honda Exp $
 */
...
#undef CPUEXC1				/* CPU例外ハンドラをサポートしない */
#define OMIT_VGET_TIM
#define LOOP_REF	800000	/* 速度計測用のループ回数 */
...
#define RAISE_CPU_EXCEPTION  *(volatile int*)(0x80000000) = 0x11;
#define STACK_SIZE           1024 

#elif defined(ARMV7M) || defined(ARMV8M)
...
#define RAISE_CPU_EXCEPTION	 Asm("ebreak");
#define STACK_SIZE           1024 
