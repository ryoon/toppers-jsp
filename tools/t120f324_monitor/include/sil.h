 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: sil.h 2242 2021-11-20 14:15:50Z roi $
 */
...
#if !defined(_MACRO_ONLY) && !defined(TOPPERS_MACRO_ONLY)
/*
 *  Type Definitions
 */
#if defined(_int8_) && !defined(_STDINT_H)
typedef	unsigned _int8_		uint8_t;	/* 符号無しビットの値 */
#endif /* _int8_ */
#if defined(_int16_) && !defined(_STDINT_H)
typedef	unsigned _int16_ 	uint16_t;	/* 符号無し16ビット整数 */
#endif /* _int16_ */
#if defined(_int32_)
#if !defined(_STDINT_H)
typedef	unsigned _int32_	uint32_t;	/* 符号無し32ビット整数 */
#endif
typedef unsigned _int32_	ulong_t;	/* 符号無しlong整数 */
#endif	/* _int32_ */
#if defined(_int64_) && !defined(_STDINT_H)
typedef	unsigned _int64_	uint64_t;	/* 符号無しビットの値 */
#endif /* _int64_ */
...
#if SIL_ENDIAN != 0			/* ビッグエンディアンプロセッサ */
