...
makeoffset()
{
	...
	OFFSET_DEF2(TPCB, sys_tpcb.excpt_nest_count, excpt_nest_count);
	OFFSET_DEF2(TPCB, sys_tpcb.p_exch_tbl, p_exch_tbl);
	OFFSET_DEF2(TPCB, sys_tpcb.p_inth_tbl, p_inth_tbl);
