 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: pl310.h 1060 2026-01-16 16:51:36Z ertl-honda $
 */
...
#define PL310_L2CACHE_BASE	0xFFFEF000
...
#ifndef _MACRO_ONLY
extern void pl310_init(UW aux_val, UW aux_mask);
extern void pl310_debug_set(UW val);
