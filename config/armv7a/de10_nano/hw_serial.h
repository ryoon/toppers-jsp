 ...
 * 
 *  @(#) $Id: hw_serial.h 889 2026-03-06 15:22:30Z roi $
 */

/*
 *	シリアルI/Oデバイス（SIO）ドライバ（NE10-Nano用）
 */
 ...
 *  SIOの割込みハンドラのベクタ番号
 */
#define INHNO_SIO1      IREQ_UART0
#define INTNO_SIO1      INHNO_SIO1
#ifdef USE_FPGAUART
#define INHNO_SIO2      IREQ_F2S_FPGA_IRQ0
#else
#define INHNO_SIO2      IREQ_UART1
#endif
