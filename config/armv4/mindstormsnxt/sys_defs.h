...
/*
 *  ターゲットシステムに依存する定義（mindstorm-nxt用）
 *
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME "MINDSTORMS - NXT"
#define MINDSTORMSNXT

/* カーネル起動時のメッセージ   */
#define COPYRIGHT_SYS \
"Copyright (C) 2009 by GJ Designing Center Print Business Group RICOH COMPANY,LTD. JAPAN\n"
