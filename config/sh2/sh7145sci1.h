 ...
 * 
 *  @(#) $Id: sh7145sci1.h,v 1.3 2004/10/04 12:18:45 honda Exp $
 */
...
#ifndef _sh7145sci1_H_
#define _sh7145sci1_H_
 ...
 *  コントロールレジスタのアドレス 
 */
#define SCI_SCR	(VB *)0xffff81b2
#define SCI_SSR	(VB *)0xffff81b4
#define SCI_BRR	(VB *)0xffff81b1
#define SCI_SMR	(VB *)0xffff81b0
#define SCI_TDR	(VB *)0xffff81b3
#define SCI_RDR	(VB *)0xffff81b5
#define SCI_SDCR	(VB *)0xffff81b6
...
#define PFC_TXD	0x0100
#define PFC_RXD	0x0040
