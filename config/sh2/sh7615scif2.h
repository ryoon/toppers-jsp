 ...
 * 
 *  @(#) $Id: sh7615scif2.h,v 1.3 2004/10/04 12:18:45 honda Exp $
 */
 ...
 *  コントロールレジスタのアドレス 
 */
#define SCIF_SC1SSR	(VH *)0xfffffce8
#define SCIF_SC2SSR	(VB *)0xfffffcea
#define SCIF_SCFRDR	(VB *)0xfffffcec
#define SCIF_SCFTDR	(VB *)0xfffffce6
#define SCIF_SCSCR	(VB *)0xfffffce4
#define SCIF_SCFCR	(VB *)0xfffffcee
#define SCIF_SCSMR	(VB *)0xfffffce0
#define SCIF_SCBRR	(VB *)0xfffffce2
...
#define PFC_TXD 		 0x0200	/*  TXD選択  	*/
#define PFC_RXD 		 0x0800	/*  RXD選択  	*/
