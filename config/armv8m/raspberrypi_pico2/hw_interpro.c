 ...
 * 
 *  @(#) $Id: hw_interpro.c 2246 2025-12-15 15:32:41Z roi $
 */

/*
 *  プロセッサ間割込みのシステム依存部（raspberrypi_pico2用）
 */
...
interpro_term(void)
{
	x_config_int(INHNO_IPI_PRC, FALSE, INTPRI_IPI_PRC);
}
