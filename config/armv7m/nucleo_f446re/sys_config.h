 ...
 * 
 *  @(#) $Id: sys_config.h 1952 2025-11-01 08:46:45Z roi $
 */

/*
 *		ターゲット依存モジュール（NUCLEO-F446RE用）
 */
...
#define IRQ_VECTOR_TIM1_TRG_COM_TIM126	/* TIM1 Trigger and Commutation Interrupt and TIM11 global interrupt */
...
#define IRQ_VECTOR_FSMC             48	/* FSMC global Interrupt */
#define IRQ_VECTOR_SDIO             49	/* SDIO global Interrupt */
