 ...
 * 
 *  @(#) $Id: sys_defs.h 2246 2025-11-19 11:58:51Z roi $
 */
...
#define TOPPERS_STM32G474_NUCLEO64

/*
 *  起動メッセージのターゲットボード名
 */
#define	TARGET_NAME	"CORTEX-M4 - NUCLEO-G474RE"
 ...
 *  スタック定義
 */
#define STACKTOP	0x10008000U	/* 非タスクコンテキスト用のスタックの初期値 */
