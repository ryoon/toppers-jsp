 ...
 * 
 *  @(#) $Id: sys_config.c 2246 2025-11-02 10:23:18Z roi $
 */
...
const FP vector_table[TMAX_INTNO + NUM_EXCNO + 1] = {
	...
	(FP)(pendsvc_handler),	/* 14 */
 	...
 	(FP)(cpu_int_entry),	/* 98 */
 	(FP)(cpu_int_entry),	/* 99 */
 	(FP)(cpu_int_entry),	/* 100 */
 	(FP)(cpu_int_entry),	/* 101 */
 	(FP)(cpu_int_entry),	/* 102 */
 	(FP)(cpu_int_entry),	/* 103 */
 	(FP)(cpu_int_entry),	/* 104 */
 	(FP)(cpu_int_entry),	/* 105 */
 	(FP)(cpu_int_entry),	/* 106 */
 	(FP)(cpu_int_entry),	/* 107 */
 	(FP)(cpu_int_entry),	/* 108 */
 	(FP)(cpu_int_entry)		/* 109 */
};
