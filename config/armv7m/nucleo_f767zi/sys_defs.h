 ...
 * 
 *  @(#) $Id: sys_defs.h 2246 2025-11-19 11:53:33Z roi $
 */
...
#define TOPPERS_STM32F767_NUCLEO144

/*
 *  起動メッセージのターゲットボード名
 */
#define	TARGET_NAME	"CORTEX-M7 - NUCLEO-F767ZI"
 ...
 *  スタック定義
 */
#define STACKTOP	0x20078000U	/* 非タスクコンテキスト用のスタックの初期値 */
