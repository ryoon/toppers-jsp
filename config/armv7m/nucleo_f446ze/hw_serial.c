 ...
 * 
 *  @(#) $Id: hw_serial.c 2246 2025-12-09 11:46:19Z roi $
 */

/*
 *		シリアルI/Oデバイス（SIO）ドライバ（NUCLEO-F446ZE用）
 */
...
const SIOPINIB siopinib_table[TNUM_SIOP] = {
	{0x40004800, (INTNO)INTNO_SIO1, 7,	/* USART3 */
	...
	{0x40011400, (INTNO)INTNO_SIO2, 7,	/* USART6 */
	 (UW)0x40023844, (UW)0x00000020,	/* RCC_APB2ENR/RCC_APB2ENR_USART6EN */
     (UW)0x40023830, (UW)0x00000040,	/* RCC_AHB1ENR/RCC_AHB1ENR_GPIOGEN */
	 (UW)GPIO_AF8,
