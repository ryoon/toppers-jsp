 ...
 * 
 *  @(#) $Id: sys_defs.h 2246 2025-11-19 11:51:15Z roi $
 */
...
#define TOPPERS_STM32F446_NUCLEO144

/*
 *  起動メッセージのターゲットボード名
 */
#define	TARGET_NAME	"CORTEX-M4 - NUCLEO-F446ZE"
 ...
 *  スタック定義
 */
#define STACKTOP	0x20020000U	/* 非タスクコンテキスト用のスタックの初期値 */
