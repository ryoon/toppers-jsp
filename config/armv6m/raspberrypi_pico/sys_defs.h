 ...
 * 
 *  @(#) $Id: sys_defs.h 2246 2026-01-03 16:13:16Z roi $
 */
 ...
 *  ターゲットを識別するためのマクロの定義
 */
#define TOPPERS_RASPBERRYPI_PICO				/* システム略称 */

/*
 *  起動メッセージのターゲットボード名
 */
#define	TARGET_NAME	"CORTEX-M0+ - RASPBERRYPI_PICO"
 ...
 *  スタック定義
 */
#define STACKTOP	0x20040000U	/* 非タスクコンテキスト用のスタックの初期値 */
