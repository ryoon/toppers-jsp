 ...
 * 
 *  @(#) $Id: sys_defs.h 2246 2025-11-19 11:28:09Z roi $
 */
 ...
 *  プロセッサタイプ
 */
#define NUCLEO_G0B1RE
#define TOPPERS_STM32G0B1_NUCLEO64

/*
 *  起動メッセージのターゲットボード名
 */
#define	TARGET_NAME	"CORTEX-M0+ - NUCLEO-G0B1RE"
 ...
 *  スタック定義
 */
#define STACKTOP	0x20024000U	/* 非タスクコンテキスト用のスタックの初期値 */
#define PSTACKSIZE	2048U
