 ...
 * 
 *  @(#) $Id: h8_3068f.h,v 1.4 2003/11/11 10:07:15 honda Exp $
 */
...
#define H8IPR_TU160_BIT		2	/* 16 bit timer 0	*/
#define H8IPR_TU161_BIT		1	/* 16 bit timer 1	*/
#define H8IPR_TU162_BIT		0	/* 16 bit timer 2	*/
...
#define H8IPR_TU160		(1<<(H8IPR_TU160_BIT))
#define H8IPR_TU161		(1<<(H8IPR_TU161_BIT))
#define H8IPR_TU162		(1<<(H8IPR_TU162_BIT))
