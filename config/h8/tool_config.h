...
#define LOG_CHG_PID_ENTER(tskid, prcid)
#define LOG_CHG_PID_LEAVE(ercd)
#define LOG_GET_PID_ENTER(tskid, p_prcid)
#define LOG_GET_PID_LEAVE(ercd, prcid);
...
#define LOG_VXCFG_INT_ENTER(intno, intreq, intpri)
#define LOG_VXCFG_INT_LEAVE(ercd)
