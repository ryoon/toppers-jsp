 ...
 * 
 *  @(#) $Id: hw_interpro.h 889 2025-12-15 15:16:30Z roi $
 */

/*
 * プロセッサ間割込みに関する定義（raspberrypi_pico2用）
 */
 ...
 */
#define INHNO_IPI_PRC	IRQ_VECTOR_SIO_FIFO
#define INTNO_IPI_PRC	INHNO_IPI_PRC
#define INTPRI_IPI_PRC	7		/* 割込み優先度 */
