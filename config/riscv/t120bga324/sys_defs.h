 ...
 * 
 *  @(#) $Id: sys_defs.h 2246 2025-11-19 10:54:07Z roi $
 */
 ...
 *  ターゲットを識別するためのマクロの定義
 */
#define TOPPERS_SAPPHIRESOC			/* システム略称 */

/*
 *  起動メッセージのターゲットボード名
 */
#define	TARGET_NAME	"RISC-V - T120BGA324"
 ...
 *  スタック定義
 */
#define STACKTOP	0xF9020000U	/* 非タスクコンテキスト用のスタックの初期値 */
